...
namespace base
{
    ...
    void ImageTest::testOpenUnknownFile()
    {
        ...
        CPPUNIT_ASSERT_THROW(m_image->open("unknown.jpg"), strom::FileAccessFailed);
    }
    ...
    void ImageTest::testImageFile()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(strom::Image::BGR_24, m_image->pixelType());
    ...
    void ImageTest::testImageDefault()
    {
        ...
        CPPUNIT_ASSERT_EQUAL(strom::Image::NONE, m_image->pixelType());
        CPPUNIT_ASSERT_EQUAL((uint8_t*)(0), m_image->data());
    }
    
    void ImageTest::testImageRgb24()
    {
        CPPUNIT_ASSERT_NO_THROW(m_image = new Image(200, 100, strom::Image::RGB_24));
        ...
        CPPUNIT_ASSERT_EQUAL(strom::Image::RGB_24, m_image->pixelType());
        CPPUNIT_ASSERT(m_image->data());
        delete m_image;
        
        CPPUNIT_ASSERT_NO_THROW(m_image = new Image(0, 0, strom::Image::RGB_24));
    }
    
    void ImageTest::testImageMono8()
    {
        CPPUNIT_ASSERT_NO_THROW(m_image = new Image(200, 100, strom::Image::MONO_8));
        CPPUNIT_ASSERT_EQUAL((unsigned int)(200), m_image->width());
        CPPUNIT_ASSERT_EQUAL((unsigned int)(100), m_image->height());
        CPPUNIT_ASSERT_EQUAL((unsigned int)(200), m_image->stride());
        CPPUNIT_ASSERT_EQUAL(strom::Image::MONO_8, m_image->pixelType());
        CPPUNIT_ASSERT(m_image->data());
        delete m_image;
        
        CPPUNIT_ASSERT_NO_THROW(m_image = new Image(0, 0, strom::Image::MONO_8));
    }

    void ImageTest::testSaveJpeg()
    {
        m_image = new Image(200, 100, strom::Image::RGB_24);
    ...
    {
        m_image = new Image(200, 100, strom::Image::RGB_24);
        CPPUNIT_ASSERT_THROW(m_image->save("unknown_dir/ImageTest_testSaveJpeg.jpg"), strom::FileAccessFailed);
    }
    ...
    void ImageTest::testSerialize()
    {
        ...
        CPPUNIT_ASSERT_THROW(m_image->serialize("ImageTest_testSerialize", "unknown_dir/"), strom::SerializationError);
    ...
    void ImageTest::testDeserialize()
    {
        ...
        CPPUNIT_ASSERT_THROW(m_image->deserialize("unknown.png", "./"), strom::DeserializationError);
