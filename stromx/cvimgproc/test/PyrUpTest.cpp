...
namespace stromx
{
    namespace cvimgproc
    {
        ...
        void PyrUpTest::testManual0()
        {
            ...
            runtime::DataContainer dst(new cvimgutil::Image(10000000));
            ...
            cvimgutil::Image::save("PyrUpTest_testManual0.png", access());
        }
        ...
        void PyrUpTest::testAllocate0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            cvimgutil::Image::save("PyrUpTest_testAllocate0.png", access());
        }
