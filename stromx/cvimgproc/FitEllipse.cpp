...
namespace stromx
{
    namespace cvimgproc
    {
        ...
        const std::vector<const runtime::Description*> FitEllipse::setupOutputs()
        {
            ...
            case(ALLOCATE):
                {
                    runtime::MatrixDescription* ellipse = new runtime::MatrixDescription(ELLIPSE, runtime::DataVariant::FLOAT_32_MATRIX);
            ...
            case(ALLOCATE):
                {
                    ...
                    checkMatrixData(*pointsCastedData, m_pointsDescription, *this);
