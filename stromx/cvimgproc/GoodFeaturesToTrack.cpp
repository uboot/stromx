                ...
                case K:
                    {
                        ...
                        checkNumericValue(castedValue, m_kParameter, *this);
                        m_k = castedValue;
                    }
                    break;
                case MAX_CORNERS:
                    {
                        ...
                        checkNumericValue(castedValue, m_maxCornersParameter, *this);
                ...
                case MIN_DISTANCE:
                    {
                        ...
                        checkNumericValue(castedValue, m_minDistanceParameter, *this);
                ...
                case QUALITY_LEVEL:
                    {
                        ...
                        checkNumericValue(castedValue, m_qualityLevelParameter, *this);
            ...
            case(ALLOCATE):
                {
                    ...
                    m_useHarrisDetectorParameter = new runtime::Parameter(USE_HARRIS_DETECTOR, runtime::DataVariant::BOOL);
