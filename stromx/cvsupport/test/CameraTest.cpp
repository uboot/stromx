...
#include "stromx/cvsupport/test/CameraTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvsupport::CameraTest);
    ...
    namespace cvsupport
    {
        ...
        void CameraTest::testExecuteSoftwareTrigger()
        {
            ...
            
            {
                ...
                cvsupport::Image::save("CameraTest_testExecuteSoftwareTrigger.png", image);
            }
        ...
        void CameraTest::testAdjustPixelType()
        {
            ...
            cvsupport::Image::save("CameraTest_testAdjustPixelTypeBayerBg8.png", image);
        }
        ...
        void CameraTest::testAdjustRoi()
        {
            ...
            cvsupport::Image::save("CameraTest_testAdjustRoi.png", image);
        }
        ...
        void CameraTest::testAdjustExposure()
        {
            ...
            cvsupport::Image::save("CameraTest_testAdjustExposure.png", image);
        }
        ...
        void CameraTest::testAdjustWhiteBalance()
        {
            ...
            cvsupport::Image::save("CameraTest_testAdjustWhiteBalance.png", image);
        }
