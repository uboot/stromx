...
#include "stromx/cvsupport/test/ClipTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvsupport::ClipTest);
...
namespace stromx
{
    ...
    namespace cvsupport
    {
        ...
        void ClipTest::testExecute()
        {
            ...
            cvsupport::Image::save("ClipTest_testExecute.png", image);
        }
        ...
        void ClipTest::testAdjustClipRegion1()
        {
            ...
            cvsupport::Image::save("ClipTest_testAdjustClipRegion1.png", image);
        }
