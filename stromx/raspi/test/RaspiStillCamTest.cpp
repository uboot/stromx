...
namespace stromx
{
    ...
    namespace raspi
    {
        ...
        void RaspiStillCamTest::testExecute()
        {
            ...
            runtime::DataContainer result = m_operator->getOutputData(RaspiCam::IMAGE);
            
            runtime::ReadAccess<runtime::Image> access(result);
            cvsupport::Image::save("RaspiCamTest_testExecute.png", access());
        }
        ...
        void RaspiStillCamTest::testExecuteTwice()
        {
            ...
            
            {
                ...
                cvsupport::Image::save("RaspiCamTest_testExecuteTwice_0.png", access0());
            }
            
            m_operator->clearOutputData(RaspiCam::IMAGE);
            
            {
                runtime::DataContainer result = m_operator->getOutputData(RaspiCam::IMAGE);
                runtime::ReadAccess<runtime::Image> access1(result);
                cvsupport::Image::save("RaspiCamTest_testExecuteTwice_1.png", access1());
            }
        }
        ...
        {
            m_operator->initialize();
            m_operator->setParameter(RaspiCam::NUM_BUFFERS, runtime::UInt32(2));
            m_operator->activate();
            
            runtime::DataContainer result;
            result = m_operator->getOutputData(RaspiCam::IMAGE);
            runtime::ReadAccess<runtime::Image> access0(result);
            cvsupport::Image::save("RaspiCamTest_testExecuteTwoBuffers_0.png", access0());
            
            m_operator->clearOutputData(RaspiCam::IMAGE);
            
            result = m_operator->getOutputData(RaspiCam::IMAGE);
            runtime::ReadAccess<runtime::Image> access1(result);
            cvsupport::Image::save("RaspiCamTest_testExecuteTwoBuffers_1.png", access1());
        }
        ...
        void RaspiStillCamTest::testGetShutterSpeed()
        {
            ...
            DataRef value = m_operator->getParameter(RaspiCam::SHUTTER_SPEED);
        ...
        void RaspiStillCamTest::testSetShutterSpeed()
        {
            ...
            m_operator->setParameter(RaspiCam::SHUTTER_SPEED, UInt32(200000));
        ...
        {
            m_operator->initialize();
            m_operator->setParameter(RaspiCam::SHUTTER_SPEED, UInt32(100));
            m_operator->setParameter(RaspiCam::RESOLUTION,
                                     runtime::Enum(RaspiCam::RESOLUTION_640_BY_480));
            m_operator->activate();
        ...
        void RaspiStillCamTest::testFramesPerSecond1280()
        {
            ...
            m_operator->setParameter(RaspiCam::SHUTTER_SPEED, UInt32(100));
            m_operator->setParameter(RaspiCam::RESOLUTION,
                                     runtime::Enum(RaspiCam::RESOLUTION_1280_BY_960));
            m_operator->activate();
        ...
        void RaspiStillCamTest::testFramesPerSecond2560()
        {
            ...
            m_operator->setParameter(RaspiCam::SHUTTER_SPEED, UInt32(100));
            m_operator->setParameter(RaspiCam::RESOLUTION,
                                     runtime::Enum(RaspiCam::RESOLUTION_2560_BY_1920));
            m_operator->activate();
        ...
        void RaspiStillCamTest::testFramesPerSecondRoi()
        {
            ...
            m_operator->setParameter(RaspiCam::RESOLUTION,
                                     runtime::Enum(RaspiCam::RESOLUTION_2560_BY_1920));
            m_operator->setParameter(RaspiCam::WIDTH, Float32(0.5));  
            m_operator->setParameter(RaspiCam::HEIGHT, Float32(0.5)); 
        ...
        void RaspiStillCamTest::testSetResolution()
        {
            ...
            DataRef value = m_operator->getParameter(RaspiCam::RESOLUTION);          
            CPPUNIT_ASSERT_EQUAL(Enum(RaspiCam::RESOLUTION_2560_BY_1920), data_cast<Enum>(value));
        }
        ...
        void RaspiStillCamTest::testSetRoi()
        {
            ...
            m_operator->setParameter(RaspiCam::LEFT, Float32(0.25));  
            m_operator->setParameter(RaspiCam::TOP, Float32(0.3));   
            m_operator->setParameter(RaspiCam::WIDTH, Float32(0.5));  
            m_operator->setParameter(RaspiCam::HEIGHT, Float32(0.4));  
        ...
        void RaspiStillCamTest::testSetRoiAndExecute()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            cvsupport::Image::save("RaspiCamTest_testSetRoiAndExecute.png", access());
        }
