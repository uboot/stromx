...
#ifndef STROMX_IMGUTIL_BUFFER_H
#define STROMX_IMGUTIL_BUFFER_H
...
namespace stromx
{
    ...
    namespace cvimgutil
    {
        ...
        class STROMX_IMGUTIL_API Buffer : public runtime::OperatorKernel
        {
        public:
            enum OutputId
            {
