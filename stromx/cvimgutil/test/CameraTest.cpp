...
#include "stromx/cvimgutil/test/CameraTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvimgutil::CameraTest);
    ...
    namespace cvimgutil
    {
        ...
        void CameraTest::testExecuteSoftwareTrigger()
        {
            ...
            
            {
                ...
                cvimgutil::Image::save("CameraTest_testExecuteSoftwareTrigger.png", image);
            }
        ...
        void CameraTest::testAdjustPixelType()
        {
            ...
            cvimgutil::Image::save("CameraTest_testAdjustPixelTypeBayerBg8.png", image);
        }
        ...
        void CameraTest::testAdjustRoi()
        {
            ...
            cvimgutil::Image::save("CameraTest_testAdjustRoi.png", image);
        }
        ...
        void CameraTest::testAdjustExposure()
        {
            ...
            cvimgutil::Image::save("CameraTest_testAdjustExposure.png", image);
        }
        ...
        void CameraTest::testAdjustWhiteBalance()
        {
            ...
            cvimgutil::Image::save("CameraTest_testAdjustWhiteBalance.png", image);
        }
