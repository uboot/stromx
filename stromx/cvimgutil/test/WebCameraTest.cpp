...
#include "stromx/cvimgutil/test/WebCameraTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvimgutil::WebCameraTest);
    ...
    namespace cvimgutil
    {
        ...
        void WebCameraTest::testExecute()
        {
            if(m_hasCamera)
            {
                ...
                cvimgutil::Image::save("WebCameraTest_testExecute.png", image);
