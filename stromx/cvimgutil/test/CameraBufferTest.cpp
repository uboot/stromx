...
#include "stromx/cvimgutil/impl/CameraBuffer.h"
#include "stromx/cvimgutil/test/CameraBufferTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvimgutil::CameraBufferTest);
