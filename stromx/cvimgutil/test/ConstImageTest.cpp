...
#include "stromx/cvimgutil/test/ConstImageTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvimgutil::ConstImageTest);
...
namespace stromx
{
    ...
    namespace cvimgutil
    {
        ...
        void ConstImageTest::testExecute()
        {
            ...
            cvimgutil::Image::save("ConstImageTest_testExecute.png", image);
        }
