...
#include "stromx/cvimgutil/test/AdjustRgbChannelsTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvimgutil::AdjustRgbChannelsTest);
...
namespace stromx
{
    ...
    namespace cvimgutil
    {
        ...
        void AdjustRgbChannelsTest::testExecute()
        {
            ...
            cvimgutil::Image::save("AdjustRgbChannelsTest_testExecute.png", image);
        }
