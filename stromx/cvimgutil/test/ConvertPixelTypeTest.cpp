...
#include "stromx/cvimgutil/test/ConvertPixelTypeTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::cvimgutil::ConvertPixelTypeTest);
...
namespace stromx
{
    ...
    namespace cvimgutil
    {
        ...
        void ConvertPixelTypeTest::testExecuteMono8()
        {
            ...
            cvimgutil::Image::save("ConvertPixelTypeTest_testExecuteMono8.png", image);
        }
        ...
        void ConvertPixelTypeTest::testExecuteBayerBg8()
        {
            ...
            cvimgutil::Image::save("ConvertPixelTypeTest_testExecuteBayerBg8.png", image);
        }
        ...
        void ConvertPixelTypeTest::testExecuteBayerRgb24()
        {
            ...
            cvimgutil::Image::save("ConvertPixelTypeTest_testExecuteBayerRgb24.png", image);
        }
