...
namespace stromx
{
    namespace cvimgutil
    {
        ...
        const std::string Matrix::PACKAGE = STROMX_IMGUTIL_PACKAGE_NAME;
        ...
        Matrix::Matrix(const stromx::cvimgutil::Matrix& matrix)
        ...
        void Matrix::doDeserialize(std::istream& in, cvimgutil::Matrix & matrix)
        {
            /*
            * TODO
            * 
