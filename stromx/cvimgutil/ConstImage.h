...
#ifndef STROMX_IMGUTIL_CONSTIMAGE_H
#define STROMX_IMGUTIL_CONSTIMAGE_H
...
namespace stromx
{
    ...
    namespace cvimgutil
    {
        ...
        class STROMX_IMGUTIL_API ConstImage : public runtime::OperatorKernel
        {
        public:
            enum OutputIds
            {
...
#endif // STROMX_IMGUTIL_CONSTIMAGE_H
