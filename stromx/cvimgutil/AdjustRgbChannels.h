...
#ifndef STROMX_IMGUTIL_ADJUSTRGBCHANNELS_H
#define STROMX_IMGUTIL_ADJUSTRGBCHANNELS_H
...
namespace stromx
{
    ...
    namespace cvimgutil
    {
        ...
        class STROMX_IMGUTIL_API AdjustRgbChannels : public runtime::OperatorKernel
        {
        public:
            enum InputId
            {
...
#endif // STROMX_IMGUTIL_ADJUSTRGBCHANNELS_H
