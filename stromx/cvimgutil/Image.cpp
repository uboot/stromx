...
namespace stromx
{
    namespace cvimgutil
    {
        ...
        const std::string Image::PACKAGE = STROMX_IMGUTIL_PACKAGE_NAME;
        ...
        Image::Image(const stromx::cvimgutil::Image& image)
        ...
        int Image::getCvAccessType(const stromx::cvimgutil::Image::Conversion access)
        {
