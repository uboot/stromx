...
namespace stromx
{
    namespace cvimgutil
    {
        ...
        const std::string WebCamera::PACKAGE(STROMX_IMGUTIL_PACKAGE_NAME);
        const runtime::Version WebCamera::VERSION(STROMX_IMGUTIL_VERSION_MAJOR,STROMX_IMGUTIL_VERSION_MINOR,STROMX_IMGUTIL_VERSION_PATCH);
        ...
        {            
            ...
            *m_webcam >> currentFrame;
            ...
            cvimgutil::Image* outImage = new cvimgutil::Image(frameCopy);
