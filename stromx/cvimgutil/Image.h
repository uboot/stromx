...
#ifndef STROMX_IMGUTIL_IMAGE_H
#define STROMX_IMGUTIL_IMAGE_H
...
namespace stromx
{
    namespace cvimgutil
    {
        ...
        public:
            ...
            /** Copy constructs an image from \c image. */
            explicit Image(const stromx::cvimgutil::Image& image);
             ...
             * OpenCV matrix to an stromx::cvimgutil::Image object.
             */
             ...
             * Creates an image from \c cvImage. The input image is \em not copied but 
             * a reference to it is held in the constructed image. Use this to convert an
             * OpenCV matrix to an stromx::cvimgutil::Image object. The pixel type of the 
