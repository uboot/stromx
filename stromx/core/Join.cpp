...
namespace stromx
{
    namespace core
    {
        ...
        const std::string Join::PACKAGE(STROMX_CORE_PACKAGE_NAME);
        ...
        void Join::setParameter(unsigned int id, const core::Data& value)
        {
            UInt32 uintValue;
        ...
        const std::vector<const Parameter*> Join::setupParameters()
        {
            ...
            NumericParameter<UInt32>* numInputs = new NumericParameter<UInt32>(NUM_INPUTS, DataVariant::UINT_32);
