...
CPPUNIT_TEST_SUITE_REGISTRATION (stromx::core::Id2DataMapTest);
...
namespace stromx
{
    namespace core
    {
        ...
        void Id2DataMapTest::Observer::observe(const unsigned int id, const stromx::core::DataContainer& data) const
        {
            m_lastId = id;
            m_lastData = data;
        }
