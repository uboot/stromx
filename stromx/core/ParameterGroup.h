...
#ifndef STROMX_CORE_PARAMETERGROUP_H
#define STROMX_CORE_PARAMETERGROUP_H
...
namespace stromx
{
    namespace core
    {
        ...
        class STROMX_CORE_API ParameterGroup : public Parameter
        {
...
#endif // STROMX_CORE_PARAMETERGROUP_H
