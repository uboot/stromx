...
namespace stromx
{
    namespace core
    {
        ...
        const DataVariant DataVariant::PRIMITIVE = DataVariant(PRIMITIVE_ID, STROMX_CORE_PACKAGE_NAME, "Primitive");
        ...
        const DataVariant DataVariant::MATRIX = DataVariant(MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "Matrix");
        const DataVariant DataVariant::INT_MATRIX = DataVariant(INT_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "Int matrix");
        const DataVariant DataVariant::UINT_MATRIX = DataVariant(UINT_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "UInt matrix");
        const DataVariant DataVariant::INT_8_MATRIX = DataVariant(INT_8_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "Int8 matrix");
        const DataVariant DataVariant::UINT_8_MATRIX = DataVariant(UINT_8_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "UInt8 matrix");
        const DataVariant DataVariant::INT_16_MATRIX = DataVariant(INT_16_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "Int16 matrix");
        const DataVariant DataVariant::UINT_16_MATRIX = DataVariant(UINT_16_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "UInt16 matrix");
        const DataVariant DataVariant::INT_32_MATRIX = DataVariant(INT_32_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "Int32 matrix");
        const DataVariant DataVariant::UINT_32_MATRIX = DataVariant(UINT_32_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "UInt32 matrix");
        const DataVariant DataVariant::FLOAT_MATRIX = DataVariant(FLOAT_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "Float matrix");
        const DataVariant DataVariant::DOUBLE_MATRIX = DataVariant(DOUBLE_MATRIX_ID, STROMX_CORE_PACKAGE_NAME, "Double matrix");
