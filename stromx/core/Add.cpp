...
namespace stromx
{
    namespace core
    {
        const std::string Add::PACKAGE(STROMX_CORE_PACKAGE_NAME);
        const runtime::Version Add::VERSION(STROMX_CORE_VERSION_MAJOR, STROMX_CORE_VERSION_MINOR, STROMX_CORE_VERSION_PATCH);
