...
#include "stromx/imgutil/test/AdjustRgbChannelsTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgutil::AdjustRgbChannelsTest);
...
namespace stromx
{
    ...
    namespace imgutil
    {
        ...
        void AdjustRgbChannelsTest::testExecute()
        {
            ...
            imgutil::Image::save("AdjustRgbChannelsTest_testExecute.png", image);
        }
