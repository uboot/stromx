...
#include "stromx/imgutil/impl/CameraBuffer.h"
#include "stromx/imgutil/test/CameraBufferTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgutil::CameraBufferTest);
