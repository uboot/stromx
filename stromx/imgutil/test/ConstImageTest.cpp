...
#include "stromx/imgutil/test/ConstImageTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgutil::ConstImageTest);
...
namespace stromx
{
    ...
    namespace imgutil
    {
        ...
        void ConstImageTest::testExecute()
        {
            ...
            imgutil::Image::save("ConstImageTest_testExecute.png", image);
        }
