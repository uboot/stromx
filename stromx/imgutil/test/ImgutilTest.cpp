...
#include "stromx/imgutil/test/ImgutilTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgutil::ImgutilTest);
...
namespace stromx
{
    namespace imgutil
    {
        ...
        void ImgutilTest::testRegisterImgutil()
        {
            ...
            CPPUNIT_ASSERT_NO_THROW(kernel = m_factory->newOperator("Imgutil", "Camera"));
            CPPUNIT_ASSERT(kernel);
            delete kernel;
            
            runtime::Data* data = 0;
            CPPUNIT_ASSERT_NO_THROW(data = m_factory->newData("Imgutil", "Image"));
            CPPUNIT_ASSERT(data);
            delete data;
        }
