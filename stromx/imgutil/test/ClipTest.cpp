...
#include "stromx/imgutil/test/ClipTest.h"

CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgutil::ClipTest);
...
namespace stromx
{
    ...
    namespace imgutil
    {
        ...
        void ClipTest::testExecute()
        {
            ...
            imgutil::Image::save("ClipTest_testExecute.png", image);
        }
        ...
        void ClipTest::testAdjustClipRegion1()
        {
            ...
            imgutil::Image::save("ClipTest_testAdjustClipRegion1.png", image);
        }
