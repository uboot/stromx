...
namespace stromx
{
    namespace imgutil
    {
        ...
        public:
            ...
            /** Copy constructs an image from \c image. */
            explicit Image(const stromx::imgutil::Image& image);
             ...
             * OpenCV matrix to an stromx::imgutil::Image object.
             */
             ...
             * Creates an image from \c cvImage. The input image is \em not copied but 
             * a reference to it is held in the constructed image. Use this to convert an
             * OpenCV matrix to an stromx::imgutil::Image object. The pixel type of the 
