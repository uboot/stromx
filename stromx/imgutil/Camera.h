...
#ifndef STROMX_IMGUTIL_CAMERA_H
#define STROMX_IMGUTIL_CAMERA_H
...
namespace stromx
{
    ...
    namespace imgutil
    {
        ...
        class STROMX_IMGUTIL_API Camera : public runtime::OperatorKernel
        {
        public:
            enum OutputId
            {
