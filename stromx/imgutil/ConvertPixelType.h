...
#ifndef STROMX_IMGUTIL_CONVERTPIXELTYPE_H
#define STROMX_IMGUTIL_CONVERTPIXELTYPE_H
...
namespace stromx
{
    namespace imgutil
    {
        ...
        class STROMX_IMGUTIL_API ConvertPixelType : public runtime::OperatorKernel
        {
        public:
            enum InputId
            {
...
#endif // STROMX_IMGUTIL_CONVERTPIXELTYPE_H
