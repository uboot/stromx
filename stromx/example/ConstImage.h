...
#ifndef STROMX_EXAMPLE_CONSTIMAGE_H
#define STROMX_EXAMPLE_CONSTIMAGE_H
...
namespace stromx
{
    ...
    namespace example
    {
        ...
        class STROMX_EXAMPLE_API ConstImage : public runtime::OperatorKernel
        {
        public:
            enum OutputIds
            {
...
#endif // STROMX_EXAMPLE_CONSTIMAGE_H
