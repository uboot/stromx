...
#ifndef STROMX_EXAMPLE_BUFFER_H
#define STROMX_EXAMPLE_BUFFER_H
...
namespace stromx
{
    ...
    namespace example
    {
        ...
        class STROMX_EXAMPLE_API Buffer : public runtime::OperatorKernel
        {
        public:
            enum OutputId
            {
