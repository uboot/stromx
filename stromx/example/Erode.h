...
#ifndef STROMX_EXAMPLE_ERODE_H
#define STROMX_EXAMPLE_ERODE_H
...
namespace stromx
{
    namespace example
    {
        /** \brief Erodes the input image. */
        class STROMX_EXAMPLE_API Erode : public MorphologicalFilter
        {
        public:
            Erode();
