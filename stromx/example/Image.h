...
namespace stromx
{
    namespace example
    {
        ...
        class STROMX_EXAMPLE_API Image : public runtime::ImageWrapper
        {
        ...
        public:
            ...
            /** Copy constructs an image from \c image. */
            explicit Image(const stromx::example::Image& image);
             ...
             * OpenCV matrix to an stromx::example::Image object.
             */
