...
namespace stromx
{
    namespace imgproc
    {
        const std::string Threshold::PACKAGE(STROMX_IMGPROC_PACKAGE_NAME);
        const runtime::Version Threshold::VERSION(STROMX_IMGPROC_VERSION_MAJOR, STROMX_IMGPROC_VERSION_MINOR, STROMX_IMGPROC_VERSION_PATCH);
