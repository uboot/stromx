#include "stromx/imgproc/test/BlurTest.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgproc::BlurTest);
...
namespace stromx
{
    namespace imgproc
    {
        ...
        void BlurTest::testManual0()
        {
            ...
            imgutil::Image::save("BlurTest_testManual0.png", access());
        }
        ...
        void BlurTest::testManual1()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("BlurTest_testManual1.png", access());
        }
        ...
        void BlurTest::testAllocate0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("BlurTest_testAllocate0.png", access());
        }
        ...
        void BlurTest::testAllocate1()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("BlurTest_testAllocate1.png", access());
        }
        ...
        void BlurTest::testInPlace0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("BlurTest_testInPlace0.png", access());
        }
