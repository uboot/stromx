#include "stromx/imgproc/test/GaussianBlurTest.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgproc::GaussianBlurTest);
...
namespace stromx
{
    namespace imgproc
    {
        ...
        void GaussianBlurTest::testManual0()
        {
            ...
            imgutil::Image::save("GaussianBlurTest_testManual0.png", access());
        }
        ...
        void GaussianBlurTest::testManual1()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("GaussianBlurTest_testManual1.png", access());
        }
        ...
        void GaussianBlurTest::testAllocate0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("GaussianBlurTest_testAllocate0.png", access());
        }
        ...
        void GaussianBlurTest::testInPlace0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("GaussianBlurTest_testInPlace0.png", access());
        }
