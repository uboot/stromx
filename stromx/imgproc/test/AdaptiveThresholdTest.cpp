#include "stromx/imgproc/test/AdaptiveThresholdTest.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgproc::AdaptiveThresholdTest);
...
namespace stromx
{
    namespace imgproc
    {
        ...
        void AdaptiveThresholdTest::testManual0()
        {
            ...
            imgutil::Image::save("AdaptiveThresholdTest_testManual0.png", access());
        }
        ...
        void AdaptiveThresholdTest::testManual1()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("AdaptiveThresholdTest_testManual1.png", access());
        }
        ...
        void AdaptiveThresholdTest::testAllocate0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("AdaptiveThresholdTest_testAllocate0.png", access());
        }
        ...
        void AdaptiveThresholdTest::testInPlace0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("AdaptiveThresholdTest_testInPlace0.png", access());
        }
