#include "stromx/imgproc/test/DilateTest.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION (stromx::imgproc::DilateTest);
...
namespace stromx
{
    namespace imgproc
    {
        ...
        void DilateTest::testManual0()
        {
            ...
            imgutil::Image::save("DilateTest_testManual0.png", access());
        }
        ...
        void DilateTest::testManual1()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("DilateTest_testManual1.png", access());
        }
        ...
        void DilateTest::testAllocate0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("DilateTest_testAllocate0.png", access());
        }
        ...
        void DilateTest::testInPlace0()
        {
            ...
            runtime::ReadAccess<runtime::Image> access(result);
            imgutil::Image::save("DilateTest_testInPlace0.png", access());
        }
