...
namespace stromx
{
    namespace imgproc
    {
        const std::string AdaptiveThreshold::PACKAGE(STROMX_IMGPROC_PACKAGE_NAME);
        const runtime::Version AdaptiveThreshold::VERSION(STROMX_IMGPROC_VERSION_MAJOR, STROMX_IMGPROC_VERSION_MINOR, STROMX_IMGPROC_VERSION_PATCH);
