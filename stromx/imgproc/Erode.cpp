...
namespace stromx
{
    namespace imgproc
    {
        const std::string Erode::PACKAGE(STROMX_IMGPROC_PACKAGE_NAME);
        const runtime::Version Erode::VERSION(STROMX_IMGPROC_VERSION_MAJOR, STROMX_IMGPROC_VERSION_MINOR, STROMX_IMGPROC_VERSION_PATCH);
