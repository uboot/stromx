...
namespace stromx
{
    namespace imgproc
    {
        const std::string Blur::PACKAGE(STROMX_IMGPROC_PACKAGE_NAME);
        const runtime::Version Blur::VERSION(STROMX_IMGPROC_VERSION_MAJOR, STROMX_IMGPROC_VERSION_MINOR, STROMX_IMGPROC_VERSION_PATCH);
