#ifndef STROMX_IMGPROC_LAPLACIAN_H
#define STROMX_IMGPROC_LAPLACIAN_H
...
namespace stromx
{
    namespace imgproc
    {
        class STROMX_IMGPROC_API Laplacian : public runtime::OperatorKernel
        {
        public:
            enum DdepthId
            {
...
#endif // STROMX_IMGPROC_LAPLACIAN_H
