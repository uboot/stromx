...
namespace stromx
{
    namespace imgproc
    {
        const std::string BoxFilter::PACKAGE(STROMX_IMGPROC_PACKAGE_NAME);
        const runtime::Version BoxFilter::VERSION(STROMX_IMGPROC_VERSION_MAJOR, STROMX_IMGPROC_VERSION_MINOR, STROMX_IMGPROC_VERSION_PATCH);
