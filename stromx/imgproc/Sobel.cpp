...
namespace stromx
{
    namespace imgproc
    {
        const std::string Sobel::PACKAGE(STROMX_IMGPROC_PACKAGE_NAME);
        const runtime::Version Sobel::VERSION(STROMX_IMGPROC_VERSION_MAJOR, STROMX_IMGPROC_VERSION_MINOR, STROMX_IMGPROC_VERSION_PATCH);
