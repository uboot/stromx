#ifndef STROMX_IMGPROC_DILATE_H
#define STROMX_IMGPROC_DILATE_H
...
namespace stromx
{
    namespace imgproc
    {
        class STROMX_IMGPROC_API Dilate : public runtime::OperatorKernel
        {
        public:
            enum ShapeId
            {
