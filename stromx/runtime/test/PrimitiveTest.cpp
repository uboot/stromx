...
CPPUNIT_TEST_SUITE_REGISTRATION (stromx::runtime::PrimitiveTest);

namespace stromx
{
    namespace runtime
    {
        const Version PrimitiveTest::VERSION(STROMX_RUNTIME_VERSION_MAJOR, STROMX_RUNTIME_VERSION_MINOR, STROMX_RUNTIME_VERSION_PATCH);
