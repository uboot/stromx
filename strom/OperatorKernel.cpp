...
namespace strom
{
        ...
        m_parameters(parameters)
    {
        ...
        for(std::vector<const strom::Parameter*>::const_iterator iter = parameters.begin();
            iter != parameters.end();
            ++iter)
        {
    ...
    void OperatorKernel::initialize(const std::vector<const strom::Description*>& inputs,
                              const std::vector<const strom::Description*>& outputs,
                              const std::vector<const strom::Parameter*>& parameters)
    {
        for(std::vector<const strom::Description*>::const_iterator iter = inputs.begin();
            iter != inputs.end();
            ++iter)
        {
        ...
        for(std::vector<const strom::Description*>::const_iterator iter = outputs.begin();
            iter != outputs.end();
            ++iter)
        {
