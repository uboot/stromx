...
namespace strom
{
    ...
    const bool operator==(const strom::DataContainer& lhs, const strom::DataContainer& rhs)
    {
    ...
    std::ostream& operator<<(std::ostream& out, const strom::DataContainer& container)
    {
