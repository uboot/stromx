...
namespace strom
{
    namespace impl
    {
        ...
        void SynchronizedOperatorKernel::sendOutputData(const strom::Id2DataMapper& mapper)
        {
            unique_lock_t lock(m_mutex);
    ...
    void SynchronizedOperatorKernel::validateDataAccess()
    {
        ...
        void SynchronizedOperatorKernel::validateParameterType(const unsigned int id, const strom::DataVariant& type)
        {
            const Parameter& param = info()->parameter(id);
