...
namespace stream
{
    ...
    {
//         CPPUNIT_ASSERT_THROW(m_stream->addThread(0),InvalidArgument);
//         
...
//         
//         CPPUNIT_ASSERT_THROW(m_stream->addThread(thr),InvalidArgument);
    }
    
    void StreamTest::testRemoveThread()
    {
//         CPPUNIT_ASSERT_THROW(m_stream->removeThread(0),InvalidArgument);
//         
//         Thread* const thr1 = new Thread();
//         Thread* const thr2 = new Thread();
//         m_stream->addThread(thr1);
//        
//         CPPUNIT_ASSERT_THROW(m_stream->removeThread(thr2),InvalidArgument);
